...
public class JdbcInsertTest { // Save as "JdbcInsertTest.java"
    public static void main(String[] args) {
        try (
            ...
            String deleteQuery = "DELETE FROM books WHERE id > 8000";
            ...
            insertStatement.setInt(1, 8001);
            insertStatement.setString(2, "Java ABC");
            insertStatement.setString(3, "Kevin Jones");
            insertStatement.setDouble(4, 15.55);
            insertStatement.setInt(5, 55);
            insertStatement.addBatch();

            insertStatement.setInt(1, 8002);
            insertStatement.setString(2, "Java XYZ");
            insertStatement.setString(3, "Kevin Jones");
            insertStatement.setDouble(4, 25.55);
            insertStatement.setInt(5, 55);
            insertStatement.addBatch();
